...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--phase-pattern", default="*.int.tif", help="Recursive GeoTIFF glob for SWEETS wrapped phase (default: *.int.tif)")
    parser.add_argument("--coherence-pattern", default="*.int.cor.tif", help="Recursive GeoTIFF glob for SWEETS coherence (default: *.int.cor.tif)")
